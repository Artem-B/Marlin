...
#define CUSTOM_MACHINE_NAME "MP Mini+TRAMS"
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // Autotuned for MP MINI with E3D V6 head.
  #define  DEFAULT_Kp 24.12
  #define  DEFAULT_Ki 2.70
  #define  DEFAULT_Kd 53.85
...
// FIXME #define PREVENT_COLD_EXTRUSION
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 3.5, 25 }
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION   // Enable G26 mesh validation
    ...
    #define MESH_TEST_LAYER_HEIGHT    0.21875   // (mm) Default layer height for the G26 Mesh Validation Tool.
...
#define LCD_BED_LEVELING
  ...
  #define MBL_Z_STEP 0.04375    // Step size while manually probing Z axis.
