...
#define CUSTOM_MACHINE_NAME "CR-10s+TMC2130"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 1500, 100, 1000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -5.61  // Z offset: -below +above  [the nozzle]
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 25            // Mesh inset margin on print area. Overriden by MESH_{MIN/MAX}_{X/Y} in Configuration_adv.h
